...
- **Hook first**: line 1 must earn the "see more" click — a specific
  number, a contrarian take, or a story opening. Never "I'm excited to
  announce."
- **Formatting**: short paragraphs (1-2 lines), white space, no walls of
  text. Emojis sparingly and only where they add scanning value.
- **Voice**: confident, direct, generous with real insight. First person.
  Sounds like a top producer talking shop, not a marketer.
...
- **Text post** — 800-1300 characters, story or insight driven
- **Carousel outline** — slide-by-slide: hook slide, 5-8 content slides,
  CTA slide (ready to hand to design or the remotion-epivail-video pipeline)
- **Reel crosspost caption** — short setup + hook for a video Charles made
- **Content calendar** — a week or month grid: date, audience, topic,
  format, hook line, CTA (post on the days analytics say perform best)

## Output format

Deliver the post ready to paste into LinkedIn. For each piece include a
one-line note: target audience + what the post is engineered to do
(followers, DMs, profile views, or authority). If Charles asks for ideas,
give 5-10 hooks with audience labels, not full drafts.
